...
export function Sidebar({ userName, userRole, userEmail }: SidebarProps) {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-50 w-64 flex flex-col bg-[#0f1117] text-white">
      {/* Logo */}
      <div className="flex items-center gap-3 px-5 h-16 border-b border-white/6 shrink-0">
        ...
        <div>
          <span className="font-bold text-sm tracking-tight text-white">F3F Tasks</span>
          <p className="text-[10px] text-slate-500 leading-none mt-0.5">Workspace</p>
        </div>
      </div>
