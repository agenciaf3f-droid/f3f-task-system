          ...
          {bookedSummary ? (
            <>
              ...
              {bookedSummary.skipped > 0 && (
                <span className="block mt-3 p-2 rounded bg-amber-50 border border-amber-200 text-xs text-amber-700">
                  ⚠️ <strong>{bookedSummary.skipped}</strong> {bookedSummary.skipped === 1 ? "mês" : "meses"} nã{bookedSummary.skipped === 1 ? "o" : "o"} foram agendados porque ese horário já estava reservado naquele{bookedSummary.skipped === 1 ? "" : "s"} período.
                </span>
              )}
            </>
          ) : (
